    ...
    <footer className="text-white p-8 z-10">
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center">
        <div className="text-center lg:text-left mb-4 lg:mb-0 lg:w-9/12">
          ...
          <p className="text-sm pb-4">Made By <a href='https://www.linkedin.com/in/muhammed-salah-kt/' target='_blank' className='text-secondary'>Salah</a> | Made Using React | © {currentYear} All rights reserved</p>
        ...
        <div className="flex flex-row lg:flex-col lg:items-end lg:space-y-2 space-x-5 lg:w-3/12 ">
          ...
          <a href="https://www.linkedin.com/in/muhammed-salah-kt/" target="_blank" rel="noopener noreferrer" className='bg-button-hover hover:bg-secondary rounded-full flex items-center p-2 px-4 hover:outline outline-1 outline-slate-400 duration-500 transition-transform transform-gpu hover:-rotate-12'>
            <span className="text-md sm:text-lg">Contact Me</span>
          </a>
        </div>
      </div>
    </footer>
